...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      this.datetime = info.birthday
      this.address = info.address
      this.certificateNumber = info.id_no
      this.starttime = info.id_start_date
      this.endtime = info.id_expiration
      this.idImages.front = info.id_front_url
      this.idImages.back = info.id_back_url
    },
    methods: {
      imageHandler1 (data) {
        this.idImages.front = data
      ...
      toLink () {
        ...
        info.id_no = this.certificateNumber
        info.id_start_date = this.starttime
        info.id_expiration = this.endtime
        info.id_front_url = this.idImages.front
        info.id_back_url = this.idImages.back
        setStore('selfInfos', info)
